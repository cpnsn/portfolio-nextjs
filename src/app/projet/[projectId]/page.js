...
export default async function Projet({ params }) {
  ...
  return (
    <div className="bg-gradient-to-b from-beige0 to-beige1 pt-30 lg:pt-36 pb-18">
      <header className="bg-brownBg p-4 pt-8 lg:p-18 rounded-[3rem] w-[90%] xl:w-[1100px] mx-auto">
        <div className="flex flex-col text-sm">
          <div className="lg:flex justify-between">
            <div className="lg:w-[48%] xl:w-[33%] my-auto">
              <div className="relative w-full max-w-lg mb-12 px-4 lg:px-2">
              ...
              <p className="px-4 lg:px-2">{project.summary}</p>
            </div>
          ...
          <div className="lg:flex justify-between items-stretch">
            <div className="flex flex-col lg:w-[48%] xl:w-[33%] bg-beige0 py-8 px-4 lg:p-10 border border-white border-4 max-lg:-mt-10 max-lg:rounded-tl-4xl rounded-tr-4xl lg:rounded-bl-4xl">
            ...
            <div className="relative lg:w-[49%] xl:w-[64%] max-lg:-mt-8 bg-orange5 lg:bg-beige0 py-8 px-4 lg:p-10 border border-white border-4 max-lg:rounded-tr-4xl rounded-tl-4xl max-lg:rounded-bl-4xl rounded-br-4xl">
              <Image
